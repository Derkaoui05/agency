    ...
    <section className="w-full h-screen overflow-hidden md:overflow-visible flex flex-col top-10 items-center justify-center relative">
      ...
      <div className="flex flex-col justify-center items-center w-[250px] sm:w-[300px] md:w-[500px] lg:w-[700px] z-50 pointer-events-auto">
        ...
        >
          ...
          convert visitors into customers. Our expert team brings your vision to
          life with custom designs tailored to your brand.
        </motion.p>
        ...
        <div className="flex flex-row justify-center space-x-4 items-center mt-10 sm:mt-16 md:mt-20 lg:mt-20 text-xs">
          ...
          >
            <Link href="/docs/introduction">
              Contact Us <span className="font-serif ml-1">→</span>
            </Link>
          </motion.button>
          <motion.button
